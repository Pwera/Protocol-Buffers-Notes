...
static bool dynamic_init_dummy_ContextEnum_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_ContextEnum_2eproto)), true);
namespace me {
namespace piotr {
namespace wera {
