...
public class MyMessageMain {
    ...
    public MyMessageMain write() {
        MyMessage name1 = MyMessage.newBuilder().setContext(ContextEnumOuterClass.ContextEnum.GOOD).setName("name1").addNumbers(1).build();
        MyMessage name2 = MyMessage.newBuilder().setContext(ContextEnumOuterClass.ContextEnum.BAD).setName("name222").addNumbers(22).build();
